...
import type { ChartConfig, ChartTooltipProps } from "recharts/types/component/DefaultTooltipContent"
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="flex flex-col gap-1">
          {payload.map((item: any, index: number) => {
            const color = item.color || context.config[item.dataKey]?.color
            const formatter = context.config[item.dataKey]?.formatter
